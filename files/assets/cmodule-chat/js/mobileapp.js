(function () {
    var app = angular.module("cmodule", ['ngSanitize', 'angularRangeSlider', 'cmodule.filters', 'ui.bootstrap', 'angular-smilies'], function ($httpProvider) {
    ...
    app.controller("BodyController", function ($http, $scope, $interval, $timeout, $window, $location, $document) {
        ...
        $scope.set_height = function () {
            ...
            if ($scope.is_typing) {
                angular.element($scope.message_box_id).height(windowHeight - (189));
            } else {
                angular.element($scope.message_box_id).height(windowHeight - (162));
            }
        }
