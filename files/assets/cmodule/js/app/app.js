var app;
(function () {
    app = angular.module("cmodule", ['cmodule.filters', 'cmodule.services', 'ngSanitize', 'ngAnimate', 'colorpicker.module', 'checklist-model', 'ui.bootstrap', 'angular-smilies'], function ($httpProvider) {
