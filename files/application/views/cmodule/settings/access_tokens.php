...
<div class="form-group form-divider" ng-show="record.id || tokens.length == 0">
    <div class="row">
        <div class="col-md-8">
            <input class="form-control" placeholder="<?php echo $this->lang->line('site_url'); ?>" type="text" ng-model="record.site_url" />
        </div>
        <div class="col-md-4">
            <button ng-show="!record.id && tokens.length == 0" class="btn btn-primary" ng-click="generate_code($event)"><?php echo $this->lang->line('generate_code'); ?></button>
