<div class="page-sidebar" ng-init="upgrade_available()">
    ...
    <div class="sidebar-navigation mCustomScrollbar">
        <ul class="main-menu">	
            ...
            <li ng-if="is_upgradable"><a href="<?php echo site_url('c=upgrade'); ?>" class="<?php echo is_active('upgrade'); ?> upgrade-link"><i class="fa fa-cogs"></i><span class="title"><?php echo $this->lang->line('upgrade'); ?></span></a></li>
        </ul>
    </div>
</div>